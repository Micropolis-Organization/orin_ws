...
class Line:
    ...
    def curvature_meter(self):
        ...
        curvature = ((1 + (2 * coeffs[0] * y_eval + coeffs[1]) ** 2) ** 1.5) / np.absolute(2 * coeffs[0])
        if curvature > 2.5e4:
            curvature = 2.5e4
        return curvature
...
def get_steering_angle(img, line_lt, line_rt ):
     # -------------------------------Radius Calculation----------------------------- #
    """ 
        The degree of curvature is defined as the central angle to the ends of an arc 
        or chord of agreed length. 
        Various lengths are commonly used in different areas of practice. 
        This angle is also the change in forward direction as that portion of the curve is traveled. 
        Where degree of curvature is based on 100 units of arc length, 
        the conversion between degree of curvature and radius is Dr = 18000/π ≈ 5729.57795, 
    ...
    return curve_direction, degrees
