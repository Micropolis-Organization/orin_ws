...
//  interval heap.
//  @remark Exception-safety: Pre-c++17: If the comparison and swap don't throw,
//  neither do any of the interval-heap functions.
//  @remark Exception-safety: c++17: If the comparison, move-assign, and
...
#if (__cplusplus < 201103L)  //  Not c++17
