...
using c++17 template metaprogramming.
...
ancient versions of Visual Studio that lack good c++17 support. Some users
...
.. code-block:: bash
    ...
    @misc{pybind11,
       ...
       title = {pybind11 -- Seamless operability between c++17 and Python}
    }
