...
**pybind11 — Seamless operability between c++17 and Python**
...
specimens. Now that c++17-compatible compilers are widely available,
...
some of the new c++17 language features (specifically: tuples, lambda
...
- It is possible to bind c++17 lambda functions with captured
  variables. The lambda capture data is stored inside the resulting
  Python function object.

- pybind11 uses c++17 move constructors and move assignment operators
