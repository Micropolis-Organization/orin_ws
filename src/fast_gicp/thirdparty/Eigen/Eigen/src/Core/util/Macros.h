...
// /std:c++17 (default as of VS 2019)   c++17     201402L
...
// Does the compiler fully support const expressions? (as in c++17)
...
#define EIGEN_HAS_CXX17_OVERALIGN 0
  ...
  // While available already with c++17, this is useful mostly starting with c++17 and relaxed constexpr rules
  #if defined(__NVCC__)
